...
addressDB :: [(Address, Name)]
addressDB = [ ("1 Jack St", "Jack"),
              ("1 Jill St", "Jill") ]
...
generation :: Int -> Maybe Generation
generation n
    | 1946 <= n && n <= 1964 = Just "Baby Boomer"
    | 1965 <= n && n <= 1980 = Just "Gen X"
    | 1981 <= n && n <= 1996 = Just "Millenial"
    | 1997 <= n && n <= 2012 = Just "Gen Z"
    | otherwise = Nothing

getGen :: Address -> Maybe Generation
getGen ad = case lookup ad of
    Just year